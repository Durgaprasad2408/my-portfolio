          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                Thanks for visiting my portfolio! Feel free to reach out if you're interested in working together.
              </p>
            ...
            <div className="text-right">
              <p className="text-gray-400">© {new Date().getFullYear()} Durga Prasad</p>
